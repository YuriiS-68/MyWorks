...
public class Demo {
    public static void main(String[] args) {
        ...
        try {
            ...
            Transaction transaction2 = new Transaction(3333, "Odessa", 5, "good", TransactionType.OUTCOME, new Date());
            Transaction transaction3 = new Transaction(4444, "Odessa", 5, "good", TransactionType.OUTCOME, new Date());
            Transaction transaction4 = new Transaction(5555, "Odessa", 5, "good", TransactionType.OUTCOME, new Date());
            Transaction transaction5 = new Transaction(6666, "Kiev", 10, "good", TransactionType.OUTCOME, new Date());
            Transaction transaction6 = new Transaction(7777, "Odessa", 5, "good", TransactionType.OUTCOME, new Date());
            Transaction transaction7 = new Transaction(8888, "Odessa", 5, "good", TransactionType.OUTCOME, new Date());
            Transaction transaction8 = new Transaction(9999, "Odessa", 10, "good", TransactionType.OUTCOME, new Date());
