...
public class Demo {
    public static void main(String[] args)throws Exception {
        ...
        Transaction transaction1 = new Transaction(2222, "Kiev", 39, "good", TransactionType.OUTCOME, new Date());
        ...
        Transaction transaction9 = new Transaction(1010, "Odessa", 1, "good", TransactionType.OUTCOME, new Date());
